...
class _View_AppComponent0 extends import3.DebugAppView<import1.AppComponent> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    this.debug(1,0,4);
    const currVal_0:any = import5.interpolate(1,'',this.context.hello,'!');
...
export function viewFactory_AppComponent0(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import4.AppElement):import3.AppView<import1.AppComponent> {
  if ((renderType_AppComponent === (null as any))) { (renderType_AppComponent = viewUtils.createRenderComponentType('D:/wwwroot/ffff5/angular2-aot-demo/app/app.component.html',0,import9.ViewEncapsulation.None,styles_AppComponent,{})); }
